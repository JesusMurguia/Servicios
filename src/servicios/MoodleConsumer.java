...
public class MoodleConsumer {
    ...
    public void getAlumnos() throws ClientErrorException {
    ...
    public void getCursos() throws ClientErrorException {
        webTarget = client.target(BASE_URI).path("{page}")
                    .resolveTemplate("page", "server.php")
                    .queryParam("wstoken", "df4353e926da3f515f1d35a05f48d6a1")
                    .queryParam("moodlewsrestformat", "json")
    ...
    public void getCalificacionesPorCursoId(int courseid) throws ClientErrorException {
        webTarget = client.target(BASE_URI).path("{page}")
                    .resolveTemplate("page", "server.php")
                    .queryParam("wstoken", "df4353e926da3f515f1d35a05f48d6a1")
                    .queryParam("moodlewsrestformat", "json")
